...
public class WebSecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity httpSecurity) throws Exception{
        httpSecurity.cors();
        httpSecurity.csrf().disable().authorizeRequests().antMatchers("/authenticate","/registerNewUser", "/addAnnouncement", "/getAllAnnouncements", "/getAnnouncementByID/{id}",
                        "/deleteAnnouncement","/updateAnnouncement", "/getAllApplies", "/addApply", "/deleteApply").permitAll().
